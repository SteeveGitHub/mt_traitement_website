...
import mtLogo from "@public/images/not_native/LOGO_1_-removebg-preview.png"
    ...
    <footer>
      <div className="py-12 md:py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          {/* Top area: Blocks */}
          <div className="flex justify-center items-center md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">

            {/* 1st block */}
            <div className="md:col-span-4 lg:col-span-5 flex-col justify-center">
              <div className="mb-2 flex items-center justify-center">
                {/* Logo */}
                <Link href="/" className="inline-block w-20" aria-label="Cruip">
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            {/* Copyrights note */}
            <div className="text-gray-400 text-sm mr-4">&copy; MT-TRAITEMENT.COM. Tous droits réservés.</div>
