        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="shrink-0 mr-4">
            ...
            <Link href="/" className="block" aria-label="Cruip">
              ...
              {/*</svg>*/}
              <img className={"logo-mt"} alt={'logo-mt-traitement'} src={"/images/not_native/LOGO_1_-removebg-preview.png"}/>
              {/*<Image src={'/app/media/import/LOGO(1).png'} alt={"logo-mt-traitement"} width={60} height={60}/>*/}
            </Link>
          </div>
